...
--
-- Host: localhost:8889
-- Generation Time: Dec 28, 2023 at 05:57 AM
...
(91, 'Jan Patrick', 'Dela Cruz', 'Urbano', 'OCCI-850', 'patrick@fullsuite.ph', '$2a$10$OJxHM0GtkJaxpG2XKc./4OJ4/VK2l4ZQiOnNtZgwce60r0OJfgVNa', 2, '1703673406825.png', 'janpatrickdelacruzurbano@gmail.com', '09661362302', '2001-01-11', 'San Juan, Moncada, Tarlac', 'Phil-Am, Baguio City, Benguet', '2023-12-04', '2024-06-04', NULL, 'Regular', 'Male', 'Male', 'Single', NULL, NULL, 'vSE0O7QJI5VlvCvUIaYETo9fiLtEaO');
...
--
ALTER TABLE `emp`
  MODIFY `emp_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=92;
...
--
ALTER TABLE `leave_credits`
  MODIFY `leave_credits_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
