...
const EmployeeDirectoryCard = ({
  ...
  return (
    <>
      <div className="border border-gray-200 flex flex-col justify-between items-center p-5 w-64 h-[330px] cursor-default hover:shadow-lg hover:transition-shadow">
