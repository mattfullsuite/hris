          ...
          <table className="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div className="flex justify-end">
                    <button className="btn btn-sm bg-green-600 text-white hover:bg-green-800 mr-2 normal-case">
                      Approve
                    </button>
                    <button className="btn btn-sm bg-red-600 text-white hover:bg-red-800 normal-case">
                      Decline
                    </button>
                  </div>
                </td>
